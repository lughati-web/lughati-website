...
| 4 | **مدة الردّ على طلبات الحذف بالبريد** (مثلًا: 30 يومًا) | `privacy-policy.html` القسم 12 + `delete-account.html`، `[مدة الرد]` و`[response time]` |
| 5 | بعد استكمال 1–4: **أزل علامة «مسودّة قبل النشر»** من رأس الصفحة (عربي + إنجليزي) | `privacy-policy.html` → `doc-meta` |
